...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (js2-mode pyenv-mode-auto theme-changer web web-beautify web-search zen-and-art-theme py-autopep8 py-yapf pygen sexy-monochrome-theme slack virtualenvwrapper virtualenv xah-lookup windresize vlf csv-mode tango-2-theme restart-emacs magit jdee jedi flymake-lua flymake-json flycheck-pyflakes flycheck cyberpunk-theme clues-theme chyla-theme cheatsheet bongo bash-completion aws-snippets aws-ec2 all-the-icons yasnippet ztree w3 sed-mode python json-mode elpy)))
